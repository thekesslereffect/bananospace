	...
	return (
		<>
			<div className="relative flex flex-col h-screen -mt-28 justify-center items-center ">
					...
					<Image src={"/images/render1_bottom.PNG"} height={300} width={300} className="absolute z-0 translate-x-[0px] -translate-y-[240px] scale-125 filter brightness-[1.2]"/>
					<Image src={"/images/render1_top.PNG"} height={300} width={300} className="absolute z-20 translate-x-[0px] -translate-y-[240px] scale-125 filter brightness-[1.2]"/>
			...
			<div className="relative max-w-7xl mx-auto w-full">
				...
				<div className="rounded-3xl overflow-clip rotate-1 hover:rotate-0 hover:-translate-y-1 hover:scale-105 duration-300 max-h-[400px] min-h-[400px] bg-[#1d1c20]  p-8   col-span-1 shadow-[inset_0_20px_40px_-30px_rgba(255,255,255,.5)] ">
					<Image src={"/images/coinGrp1.PNG"} layout="fill" objectFit="contain" className="absolute inset-0 m-auto -translate-x-[0px] translate-y-[40px] scale-125 filter brightness-[1.2]"/>
